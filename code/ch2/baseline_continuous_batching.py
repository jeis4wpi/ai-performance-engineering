"""baseline_continuous_batching.py - Baseline static batching in hardware overview context.

Demonstrates static batching without hardware-aware optimizations.
Continuous batching: This baseline does not implement continuous batching.
Batches are processed sequentially without dynamic composition.
...
class BaselineContinuousBatchingBenchmark(Benchmark):
    ...
    Continuous batching: This baseline does not implement continuous batching.
    Batches are processed one at a time, without dynamic composition.
    """
    ...
    def setup(self) -> None:
        ...
        # Continuous batching allows dynamic batch composition for better hardware utilization
