"""baseline_double_buffering.py - Baseline without double buffering in occupancy/warp divergence context.
...
class BaselineDoubleBufferingBenchmark(Benchmark):
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("baseline_double_buffering")
        try:
            with torch.no_grad():
