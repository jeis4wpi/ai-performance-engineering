"""baseline_nvlink.py - Baseline without NVLink optimization in kernel efficiency/arithmetic intensity context.
...
class BaselineNvlinkBenchmark(Benchmark):
    ...
    def setup(self) -> None:
        ...
        # Baseline: PCIe-based communication (no NVLink-based communication)
