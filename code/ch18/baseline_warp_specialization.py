"""baseline_warp_specialization.py - Baseline without warp specialization in FlexAttention/KV cache context.
...
class BaselineWarpSpecializationBenchmark(Benchmark):
    """Baseline: All warps perform same work (no specialization).
    
    Warp specialization: This baseline does not use warp specialization.
    All warps perform the same work, reducing efficiency.
    """
