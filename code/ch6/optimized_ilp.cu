// optimized_ilp.cu
// Optimized version: Independent operations and loop unrolling for ILP
//
// Key concepts:
...
// - Loop unrolling exposes more ILP opportunities
...
int main() {
    ...
    printf("========================================\n");
    printf("Optimized: Instruction-Level Parallelism (ILP)\n");
    printf("========================================\n");
    ...
    printf("1. Independent operations (high ILP):\n");
    ...
    // Test unrolled ILP
    printf("\n2. Unrolled ILP (4 elements per thread):\n");
    ...
    if (indep_time > 0 && unrolled_time > 0) {
        float speedup = indep_time / unrolled_time;
        printf("\n  Unrolled ILP:    %.2fx speedup vs independent ops\n", speedup);
    }
