...
class TensorCoresStreamsBenchmark(Benchmark):
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("baseline_tensor_cores_streams")
        try:
...
def get_benchmark() -> Benchmark:
    ...
    return TensorCoresStreamsBenchmark()
...
if __name__ == '__main__':
    ...
    print(f"\nBaseline Tensor cores streams (Single GPU): {result.mean_ms:.3f} ms")
