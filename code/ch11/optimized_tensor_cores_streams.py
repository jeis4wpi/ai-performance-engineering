"""tensor_cores_streams.py - Concurrent kernel execution with streams (optimized).
...
class OptimizedTensorCoresStreamsBenchmark(Benchmark):
    """Tensor Cores stream-ordered optimization.
    
    Note: For warp specialization examples, see tensor_cores_streams_warp_specialized.cu
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("tensor_cores_streams_concurrent")
        try:
