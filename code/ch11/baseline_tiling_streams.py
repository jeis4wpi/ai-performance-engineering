...
class TilingStreamsBenchmark(Benchmark):
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("baseline_tiling_streams")
        try:
...
if __name__ == '__main__':
    ...
    print(f"\nBaseline Tiling streams (Single GPU): {result.mean_ms:.3f} ms")
