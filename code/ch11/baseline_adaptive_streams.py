...
class AdaptiveStreamsBenchmark(Benchmark):
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("baseline_adaptive_streams")
        try:
...
def get_benchmark() -> Benchmark:
    ...
    return AdaptiveStreamsBenchmark()
...
if __name__ == '__main__':
    ...
    print(f"\nBaseline Adaptive streams (Single GPU): {result.mean_ms:.3f} ms")
