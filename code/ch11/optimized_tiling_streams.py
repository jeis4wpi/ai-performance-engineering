"""tiling_streams.py - Concurrent kernel execution with streams (optimized).
...
class OptimizedTilingStreamsBenchmark(Benchmark):
    """Tiling stream-ordered optimization.
    
    Note: For warp specialization examples, see tiling_streams_warp_specialized.cu
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("tiling_streams_concurrent")
        try:
