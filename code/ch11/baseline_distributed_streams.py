...
class BaselineDistributedStreamsBenchmark(Benchmark):
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("baseline_distributed_streams")
        try:
...
if __name__ == '__main__':
    ...
    print(f"\nBaseline Distributed Streams (Single GPU): {result.mean_ms:.3f} ms")
