"""disaggregated_streams.py - Concurrent kernel execution with streams (optimized).
...
class OptimizedDisaggregatedStreamsBenchmark(Benchmark):
    """Disaggregated stream-ordered optimization.
    
    Note: For warp specialization examples, see disaggregated_streams_warp_specialized.cu
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("disaggregated_streams_concurrent")
        try:
