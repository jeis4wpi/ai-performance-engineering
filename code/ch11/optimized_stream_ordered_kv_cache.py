...
class OptimizedStreamOrderedKvCacheBenchmark(Benchmark):
    """Stream-ordered KV cache - kernels overlap.
    
    Note: For warp specialization examples, see stream_ordered_kv_cache_warp_specialized.cu
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("stream_ordered_kv_cache_concurrent")
        try:
