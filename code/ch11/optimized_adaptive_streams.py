"""adaptive_streams.py - Concurrent kernel execution with streams (optimized).
...
class OptimizedAdaptiveStreamsBenchmark(Benchmark):
    """Adaptive stream-ordered optimization.
    
    Note: For warp specialization examples, see adaptive_streams_warp_specialized.cu
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("adaptive_streams_concurrent")
        try:
