"""coalescing_streams.py - Concurrent kernel execution with streams (optimized).
...
class OptimizedCoalescingStreamsBenchmark(Benchmark):
    """Coalescing stream-ordered optimization.
    
    Note: For warp specialization examples, see coalescing_streams_warp_specialized.cu
    ...
    def benchmark_fn(self) -> None:
        ...
        torch.cuda.nvtx.range_push("coalescing_streams_concurrent")
        try:
