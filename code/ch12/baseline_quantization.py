"""baseline_quantization.py - Baseline without quantization in kernel launches/CUDA graphs context.

Demonstrates operations without quantization and many kernel launches (no CUDA graphs).
...
class BaselineQuantizationBenchmark(Benchmark):
    """Baseline: Full precision with many kernel launches (no CUDA graphs).
    ...
    def setup(self) -> None:
        """Setup: Initialize model without quantization or CUDA graphs."""
    ...
    def benchmark_fn(self) -> None:
        ...
        try:
            with torch.no_grad():
                ...
                # Baseline: No quantization or CUDA graphs benefits
