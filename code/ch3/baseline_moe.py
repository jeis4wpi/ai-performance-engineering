"""baseline_moe.py - Baseline dense model (no MoE) in infrastructure/OS tuning context.
    ...
    def benchmark_fn(self) -> None:
        ...
        try:
            with torch.no_grad():
                ...
                # All parameters active for every input (inefficient)
                # MoE would use sparse activation
                _ = output.sum()
        finally:
